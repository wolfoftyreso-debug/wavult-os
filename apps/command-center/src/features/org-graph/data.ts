...
export const ENTITIES: Entity[] = [
  ...
  },
  {
    ...
    jurisdiction: 'SE',
    parent_entity_id: 'wavult-group',
    description: 'Swedish holding company. Org. 559141-7042. Currently trading as Sommarliden Holding AB — planned name change to LandveX AB. EU procurement compatible. Targeting Swedish infrastructure authorities.',
    active_status: 'forming',
    color: '#EC4899',
    flag: '🇸🇪',
    layer: 2,
    metadata: {
      ...
      'Future name': 'LandveX AB (name change pending)',
      ...
      'Launch target': 'June 2026 — Swedish archipelago',
    },
  },
  // Layer 3 — Systems
  {
